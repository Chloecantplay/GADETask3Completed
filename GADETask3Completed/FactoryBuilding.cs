    ...
    public class FactoryBuilding : Building
    {
        ...
        public Unit SpawnUnit()
        {
            if (Team == 0)
            {
                ...
                else// this allows for the building to spawn the wizards of the neutral team, the wizzards however can't attack the buildings
                { 
        ...
        public override void BeingAttacked(Unit attacker)// this method allows for buildings to be attacked and thus die
        {
