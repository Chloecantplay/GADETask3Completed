    ...
    public class Map
    {
        ...
        public void Generate()
        {
            for(int i = 0; i < NumBuildings; i++)
            {
                ...
                {
                    if (random.Next(0, 2) == 0)// only the buildings are spawned, all units are generated by the buildings
                    {
                        ResourceBuilding r = new ResourceBuilding(random.Next(0, mapWidth), random.Next(0, mapHeight), 20, 0, "{}",random.Next(0,3),0,10,500);// the buildings can spawn the neutral team wizzards
                        Buildings.Add(r);
                    }
                    else
                    {
