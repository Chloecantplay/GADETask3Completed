...
namespace GADETask1
{
    ...
    public class MeleeUnit : Unit
    {
        ...
        public override void Combat(Unit attacker)
        {
            ...
            else if (attacker is WizzardUnit) ///AOE damage for the wizard
            {
        ...
        public override (Building, int) ClosestBuilding(List<Building> buildings)// allows for the buildings to be detected as the closest enemy
        {
            int shortest = 100;
