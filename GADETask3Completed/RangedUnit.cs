...
namespace GADETask1
{
    ...
    public class RangedUnit : Unit
    {
        ...
        public override void Combat(Unit attacker)
        {
            ...
            else if (attacker is WizzardUnit) // this method allows for the wizard to do area of effect damage to it
            {
        ...
        public override (Unit,int) EnemyDistance(List<Unit> units)
        {
           int shortest = 100;
            ...
            foreach(Unit u in units)
            {
                ...
                else if (u is WizzardUnit && u != this)// all methods have been updated to includde the wizard
                {
        ...
        public override (Building, int) ClosestBuilding(List<Building> buildings)// this method allows for buildings to be found as the colsest enemy
        {
            int shortest = 100;
        ...
        public override bool RangeCheck(Unit other)
        {
            ...
            else if (other is WizzardUnit)// wizzard has been added to the range check
            {
