...
namespace GADETask1
{
    ...
    class WizzardUnit : Unit
    {
            ...
            public override (Unit, int) EnemyDistance(List<Unit> units)//determines the distance between units
            {
                int shortest = 100;
                Unit closest = this;
        ...
        public override (Building, int) ClosestBuilding(List<Building> buildings)//This method isn't used by the wizzard class as it doesn't attack buildings
        {
